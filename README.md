...
# paddle 패키지 설치
COPY linux-64/paddlepaddle-gpu-3.0.0b2-py38_gpu_cuda12.3_many_linux.tar.bz2 /tmp/
RUN conda install --use-local /tmp/paddlepaddle-gpu-3.0.0b2-py38_gpu_cuda12.3_many_linux.tar.bz2
